...
export default function CourseBuilder() {
  ...
  return (
    <div className="min-h-screen bg-white text-black font-sans selection:bg-black selection:text-white">
      ...
      <main className="max-w-6xl mx-auto p-4 md:p-8 pb-24 md:pb-20">
        {isLoading && (
      ...
      {/* 主畫面底部 footer：永遠貼底（fixed），審核員與使用者隨時看得到客服資訊。
          z-40 確保它被 header (z-50)、sidebar backdrop (z-55)、loading overlay (z-50)、PaywallModal (z-100) 覆蓋。
          <main> 加上 pb-24 / md:pb-20 讓內容能滾過 footer 不被擋住底部。 */}
      <footer className="fixed bottom-0 left-0 right-0 z-40 border-t-2 border-black bg-white px-4 md:px-8 py-2 md:py-3">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 sm:gap-3 text-xs text-gray-600">
          <div className="text-center sm:text-left leading-tight">
            ...
            <span className="block md:inline whitespace-nowrap">客服時間：週一至週五 09:00-18:00</span>
          </div>
          <nav aria-label="footer" className="flex items-center justify-center gap-3 whitespace-nowrap">
            <Link href="/privacy" className="hover:underline hover:text-black">
              隱私權政策
            </Link>
            <span aria-hidden="true" className="text-gray-300">|</span>
